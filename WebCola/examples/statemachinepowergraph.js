...
(function (tetrisbug) {
    ...
    function flatGraph() {
        ...
        d3.json(graphfile, function (error, graph) {
            ...
            var swatchlabels = svg.selectAll('.swatchlabel').data(linkTypes.list).enter().append('text').text(function (t) { return t ? t : "Start"; }).attr('x', indent + 40).attr('y', function (l, i) { return topindent + 20 + 40 * i; }).attr('fill', 'black').attr('class', 'swatchlabel');
        });
    }
