define(["require", "exports", './vpsc', './shortestpaths', './longest-common-subsequence', './node-wrapper', './vert'], function(require, exports, vpsc, shortestpaths, LongestCommonSubsequence, NodeWrapper, Vert) {
    var GridRouter = (function () {
        ...
        GridRouter.nudgeSegs = function (x, y, routes, segments, leftOf, gap) {
            ...
            var vs = segments.map(function (s) {
                return new vpsc.Variable(s[0][x]);
            });
            var cs = [];
            for (var i = 0; i < n; i++) {
                for (var j = 0; j < n; j++) {
