...
define(["require", "exports", 'bintrees/lib/rbtree', './vpsc'], function(require, exports, RBTree, vpsc) {
    ...
    function computeGroupBounds(g) {
        ...
        if (typeof g.groups !== "undefined")
            g.bounds = g.groups.reduce(function (r, c) {
                return exports.computeGroupBounds(c).union(r);
            }, g.bounds);
    ...
    function removeOverlaps(rs) {
        ...
        var cs = exports.generateXConstraints(rs, vs);
        ...
        cs = exports.generateYConstraints(rs, vs);
    ...
    var Projection = (function () {
        function Projection(nodes, groups, rootGroup, constraints, avoidOverlaps) {
            ...
            if (avoidOverlaps && rootGroup && typeof rootGroup.groups !== 'undefined') {
                ...
                exports.computeGroupBounds(rootGroup);
                var i = nodes.length;
        ...
        Projection.prototype.xProject = function (x0, y0, x) {
            ...
            this.project(x0, y0, x0, x, function (v) {
                return v.px;
            }, this.xConstraints, exports.generateXGroupConstraints, function (v) {
        ...
        Projection.prototype.yProject = function (x0, y0, y) {
            ...
            this.project(x0, y0, y0, y, function (v) {
                return v.py;
            }, this.yConstraints, exports.generateYGroupConstraints, function (v) {
        ...
        Projection.prototype.project = function (x0, y0, start, desired, getDesired, cs, generateConstraints, updateNodeBounds, updateGroupBounds) {
            ...
            if (this.rootGroup && this.avoidOverlaps) {
                exports.computeGroupBounds(this.rootGroup);
