...
var D3StyleLayoutAdaptor = (function (_super) {
    ...
    function D3StyleLayoutAdaptor() {
        _super.call(this);
        this.event = d3_dispatch_1.dispatch(layout_1.EventType[layout_1.EventType.start], layout_1.EventType[layout_1.EventType.tick], layout_1.EventType[layout_1.EventType.end]);
        var d3layout = this;
        var drag;
        this.drag = function () {
            if (!drag) {
                var drag = drag()
                    ...
                    layout_1.Layout.drag(d, d3_selection_1.event);
                    d3layout.resume();
                })
    ...
    D3StyleLayoutAdaptor.prototype.kick = function () {
        var _this = this;
        d3_timer_1.timer(function () { return _super.prototype.tick.call(_this); });
    };
...
},{"./layout":8,"d3-dispatch":17,"d3-selection":18,"d3-timer":19}],4:[function(require,module,exports){
"use strict";
var Locks = (function () {
    function Locks() {
        this.locks = {};
