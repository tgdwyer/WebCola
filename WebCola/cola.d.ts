declare module 'cola/linklengths' {
...
declare module 'cola/powergraph' {
	import { LinkAccessor } from 'cola/linklengths';
...
declare module 'cola/rectangle' {
	import { Constraint, Variable } from 'cola/vpsc';
	...
	export class Projection {
	    ...
	    private variables;
	    constructor(nodes: GraphNode[], groups: RectGroup[], rootGroup?: RectGroup, constraints?: any[], avoidOverlaps?: boolean);
...
declare module 'cola/geom' {
	import { Point } from 'cola/rectangle';
...
declare module 'cola/handledisconnected' {
...
declare module 'cola/layout' {
	import { LinkLengthAccessor } from 'cola/linklengths';
	import { Rectangle } from 'cola/rectangle';
	/**
...
declare module 'cola/adaptor' {
	import { Layout, EventType, Event } from 'cola/layout';
...
declare module 'cola/gridrouter' {
	import { Rectangle, Point } from 'cola/rectangle';
...
declare module 'cola/layout3d' {
	import { Descent } from 'cola/descent';
	import { GraphNode, Rectangle } from 'cola/rectangle';
	import { Variable } from 'cola/vpsc';
	export class Link3D {
	    source: number;
	    target: number;
	    length: number;
