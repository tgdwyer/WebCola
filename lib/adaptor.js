...
var applyPacking = require('./handle_disconnected').applyPacking;
var separateGraphs = require('./handle_disconnected').separateGraphs;
...
adaptor.start = function () {
    ...
    if (ao) {
        ...
        descent.project = new vpsc.Projection(nodes, groups, rootGroup, curConstraints, true).projectFunctions();
